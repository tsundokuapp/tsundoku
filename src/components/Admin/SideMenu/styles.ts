...
export const ContainerHandlleMenu = styled.div<IContainer>`
    ...
    margin: ${(props) => props.retractMenuStatus ? "4.65rem 0 3.25rem .75rem" : "1.25rem 0 2.25rem 1.25rem" }; 
    cursor: pointer;
...
export const ContainerMenu = styled.nav<IContainerMenu>`
    width: 100%;
    margin-top: ${(props) => (props.setFooter ? props.retractMenuStatus ? "2.7rem" : "3.7rem" : 0)};
