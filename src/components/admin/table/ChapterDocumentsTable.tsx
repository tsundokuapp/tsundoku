  ...
  const RenderRow = ({
    ...
    return (
      <tr className="hidden hover:bg-appListHover md:table-row">
        ...
        {/* esconder o titulo quando é muito grande e mostrar ele quando fizer um hover */}
        <td
        ...
        <td className="px-4 py-2 text-center">
          <div className="flex flex-row justify-end gap-1">
            <div className="flex items-center justify-center hover:cursor-pointer">
              <Tooltip text={`Criador: Axios`}>
                {/* // TODO: ARRUMAR ISSO AQUI NA API */}
                <Avatar
              ...
              <Table>
                ...
                <tbody>
                  {chapters.map((chapter) => (
                    <RenderRow key={chapter.id} chapter={chapter} />
                  ))}
                </tbody>
              </Table>
            </div>
