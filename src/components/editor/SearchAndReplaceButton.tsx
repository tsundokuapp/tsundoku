...
import type { SearchAndReplaceStorage } from '@/app/editor/[documentId]/SearchAndReplace';
...
export function SearchAndReplaceButton() {
        ...
        {!replacing ? (
          ...
          <div className={cn('relative w-full')}>
            ...
            <div className="flex w-full items-center gap-3">
              ...
              <h2 className="text-sm font-medium">Buscar e Substituir</h2>
            </div>

            <div className="my-2 w-full">
              <div className="mb-3">
                <Label className="text-gray-11 mb-1 text-xs">Buscar</Label>
                <Input
                  value={searchText}
                  onChange={(e) => {
                    setSearchText(e.target.value);
