...
export const ROTAS = {
  ...
  CATEGORIAS:'/admin/admin/blog/categoorias',
  POSTS:'/admin/admin/blog/posts',
  ADICIONAR_POSTS:'/admin/admin/blog/posts/adicionar',
  EDITAR_POSTS:'/admin/admin/blog/posts/editar',
