  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        authText: 'var(--auth-text)',
        authTitle: 'var(--auth-title)',
        authSubtitle: 'var(--auth-subtitle)',
        authHighlight: 'var(--auth-highlight)',
        authHeaderText: 'var(--auth-header-text)',
        authHeaderHighlight: 'var(--auth-header-highlight)',
        authCardBackground: 'var(--auth-card-background)',
        authCardBorder: 'var(--auth-card-border)',
        authCardShadow: 'var(--auth-card-shadow)',
        authPanelBackground: 'var(--auth-panel-background)',
        authPanelBorder: 'var(--auth-panel-border)',
        authButtonBackground: 'var(--auth-button-background)',
        authButtonBorder: 'var(--auth-button-border)',
        authButtonHover: 'var(--auth-highlight)',
        authButtonText: 'var(--auth-button-text)',
        authInputBackground: 'var(--auth-input-background)',
        authInputBorder: 'var(--auth-input-border)',
        authInputText: 'var(--auth-input-text)',
        authInputPlaceholder: 'var(--auth-input-placeholder)',
        authInputIcon: 'var(--auth-input-icon)',
        authInputFocus: 'var(--auth-input-focus)',
        authSeparator: 'var(--auth-separator)',
        authErrorBackground: 'var(--auth-error-background)',
        authErrorBorder: 'var(--auth-error-border)',
        authErrorText: 'var(--auth-error-text)',
